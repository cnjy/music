<template>
  <div class="player" v-show="playList.length>0">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @perentChange="onProgressBarChange"></progress-bar>
            </div>
    ...
    <audio ref="audio" :src="currentSong.url" @canplay="ready" @timeupdate="updateTime" @ended="end"></audio>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      getLyric(){
          //this.currentSong.getLyric is not a function
